  ...
  return (
    <div className="frame">
      <div className="div">
        <div className="div-2">
          <div className="div-3">
            <div className="div-3-5"> {/**/}
              <div className="logo-uquizzle">{/* UQuizzle atas */}
                <div className="back-arrow">{/*TODO: Insert back logo di sini*/}</div>
            ...
            <div className="button-strawbz">
              <div className="text-wrapper-2">Get started</div>
              <div className="sparkle-mini">{/*TODO: Incorporate Sparkle Mini di sini*/}</div>
            </div>
          </div>
          <p className="made-with-by">
            <span className="span">Made with </span>
            <span className="text-wrapper-4">❤</span>
            <span className="span">️ by 1103ers</span>
          </p>
        </div>
      </div>
  );
