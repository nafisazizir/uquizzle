...
import './QuizzleWordLogo.css'

const QuizzleWordLogo = () => {
    return (
        <div className="quizzle-logo-container">
            <svg className="quizzle-logo" width="26" height="23" viewBox="0 0 29 26" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <span className="quizzle-text">uizzle</span>
        </div>
    )
}
export default QuizzleWordLogo